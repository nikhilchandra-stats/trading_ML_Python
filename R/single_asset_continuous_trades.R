...
single_asset_Logit_indicator <-
  function(
    ...
    actual_wins_losses_var = actual_wins_losses_var,
...
single_asset_Logit_run_and_save_models <-
  function(
    ...
    summary(cor_trig_model)
    message("Passed Cor Trig Model")
    saveRDS(object = cor_trig_model,
            file =
              glue::glue("{save_path}/{Asset_of_interest}_{trade_direction}_cor_trig_model.RDS"))
...
single_asset_Logit_run_local_models <-
  function(
    ...
    cor_trig_data <- copula_trig_accumulation %>% reduce(left_join)
    cor_trig_data_joined_returns <- cor_trig_data
    ...
    cor_trig_model <- readRDS(glue::glue("{save_path}/{Asset_of_interest}_{trade_direction}_cor_trig_model.RDS"))
    summary(cor_trig_model)
    message("Passed Cor Trig Model")
    ...
    rm(cor_trig_data, copula_trig_accumulation, cor_trig_data_joined_returns, cor_trig_model)
    gc()
