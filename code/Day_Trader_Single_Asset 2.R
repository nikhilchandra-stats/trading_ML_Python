...
indicator_mapping <- list(
  ...
  couplua_assets =
    list( c("XAU_EUR", "XAG_EUR", "EUR_JPY", "EU50_EUR", "EUR_AUD", "EUR_GBP"), #1
          ...
          c("AU200_AUD", "XAU_EUR", "FR40_EUR", "UK100_GBP", "XAU_USD", "EU50_EUR", "SPX500_USD"), #23
          c("AU200_AUD", "EUR_USD", "XAU_GBP", "XAU_EUR", "XAU_USD", "XAG_GBP", "XAG_EUR") #24
...
model_data_store_path <-
  "C:/Users/nikhi/Documents/trade_data/single_asset_improved_indcator_trades_ts_2.db"
model_data_store_db <-
...
for (k in 8:length(date_seq_simulations)) {
