...
indicator_mapping <- list(
  ...
  couplua_assets =
    list(
      c("USD_CAD", "XAU_USD", "GBP_CAD", "XAU_CAD", "XAG_USD"),
      c("XAG_CHF", "XAU_USD", "XAU_CHF", "CH20_CHF", "XAG_USD"),
      c("USB10Y_USD", "ETH_USD", "XAG_USD", "XAU_USD", "SPX500_USD")
    ),
  countries_for_int_strength =
    list(
      c("USD", "CAD", "EUR"), #1
      c("USD", "EUR", "GBP", "AUD"), #1
      c("USD", "EUR", "GBP", "AUD", "JPY") #1
    )
)
