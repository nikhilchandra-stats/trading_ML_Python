...
correlation_asset_list <-
  list(
    ...
    c("EUR_AUD", "EUR_USD", "XAU_EUR", "XAU_AUD", "NZD_USD", "EUR_JPY", "EUR_GBP",
      ...
      "FR40_EUR", "EU50_EUR", "AU200_AUD") %>% unique(),
...
for (j in 6:length(assets_to_test)) {
