...
file_name = "Equity_Port_V3_Bayes_More_vars_2"
regression_length = 22000
direct_return_cols = 49
training_date = "2021-12-16 18:00:00"

all_dates_sim <-
  Indices_Metals_Bonds[[2]] %>%
  filter(Date >= as_datetime("2019-01-01") + dhours(regression_length + 1000) ) %>%
  pull(Date) %>%
  unique()

training_date <-  min(all_dates_sim) %>% as.character()
...
#10 Dollars
trade_statment <-
  "(predicted > 55)|(pred_10000_mean_roll_10 > 60)|(pred_10000_mean_roll_1000 > 22.5)|
   (pred_10000_mean_roll_500 > 27.5)|(pred_10000_mean_roll_100 < 45 & pred_10000_mean_roll_100 > 30)"

trade_statment <-
  "(pred_10000_mean_roll_10 > 75)|
    (predicted > 55)|
    (pred_10000_mean_roll_1000 < 30 & pred_10000_mean_roll_1000 > 26)|
    (pred_10000_mean_roll_500 < 35 & pred_10000_mean_roll_500 > 25)|
   (pred_10000_mean_roll_600 < 40 & pred_10000_mean_roll_600 > 34)|
    ...
    predicted > pred_10000_mean_roll_2000 &
      predicted > pred_10000_mean_roll_10 &
      predicted > pred_10000_mean_roll_250 &
    predicted > 25 &
   pred_10000_mean_roll_10 > 25 &
   pred_10000_mean_roll_1000 > 10 &
   pred_10000_mean_roll_500 > 10 &
   pred_10000_mean_roll_600 > 10 &
   pred_10000_mean_roll_250 > 10)"

trade_statment <-
  "(pred_10000_mean_roll_500 < 30 & pred_10000_mean_roll_500 > 23)|
   (predicted > 55)|
   (pred_10000_mean_roll_250 > 44)|
   (pred_10000_mean_roll_50 > 72)|
  (pred_10000_mean_roll_2000 < 1000 & pred_10000_mean_roll_2000 > 30)|
  (pred_10000_mean_roll_1000 < 35 & pred_10000_mean_roll_1000 > 30)"

trade_statment <-
  "(predicted > 50)|
(pred_10000_mean_roll_500 < 40 & pred_10000_mean_roll_500 > 30)"

trade_statment <-
  "(pred_10000_mean_roll_1000 > 15)"
