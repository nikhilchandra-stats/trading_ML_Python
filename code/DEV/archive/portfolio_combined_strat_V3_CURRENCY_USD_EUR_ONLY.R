...
file_name = "CURRENCY_USD_EUR_ONLY"
regression_length = 18000
direct_return_cols = 48
total_lag_cols = 48
...
# 10 Dollars
db_con <- connect_db("C:/Users/nikhi/Documents/trade_data/single_asset_v3_Bayes_Reg_Portfolio/Equity_Port_V3_Results.db")
upload_dat <-
  model_prediction_data %>%
  mutate(
    # algo_name = file_name,
    algo_name = "CURRENCY_USD_EUR_ONLY_SIG_01",
    risk_dollar_value_var = risk_dollar_value_var,
    stop_factor_var = stop_factor_var,
    profit_factor_var = profit_factor_var,
    end_period = end_period,
...
#For Sig Level = 1
trade_statment <-
  "(predicted < 1000 & predicted > 90)|
   (pred_10000_mean_roll_500 < 40 & pred_10000_mean_roll_500 > 32)|
   (pred_10000_mean_roll_250 < 1000 & pred_10000_mean_roll_250 > 60)|
   (pred_10000_mean_roll_100 < 1000 & pred_10000_mean_roll_100 > 87)|
  ...
  pred_10000_mean_roll_100 > 35 &
  pred_10000_mean_roll_50 > 35 &
    predicted > 35)|
  (pred_10000_mean_roll_1000 < 1000 & pred_10000_mean_roll_1000 > 30)|
  (pred_10000_mean_roll_1500 < 1000 & pred_10000_mean_roll_1500 > 31)|
  (pred_10000_mean_roll_2000 < 1000 & pred_10000_mean_roll_2000 > 13)|
  (pred_10000_mean_roll_50 < 1000 & pred_10000_mean_roll_50 > 87)|
  (pred_10000_mean_roll_10 < 1000 & pred_10000_mean_roll_10 > 79)
"
