...
available_assets <- get_available_V3_Assets()
...
all_cor_vars <-
  ...
  keep(~ str_detect(.x, "cor_LM[0-9]+")|
         str_detect(.x, "Final_Return_lag")|
         str_detect(.x, "Period_Return_Lag_")|str_detect(.x, "state_space")|
         str_detect(.x, "brownian") ) %>%
  unlist() %>%
  as.character() %>%
  unique()
...
# # xtnd_ss_cols_PR_cols = 24
trade_statment <-
  "(predicted > 400 & predicted < 1000)|
   (pred_10000_mean_roll_250 > 250 & pred_10000_mean_roll_250 < 1000)|
   (pred_10000_mean_roll_500 > 180 & pred_10000_mean_roll_500 < 1000)|
   (pred_10000_mean_roll_1000 > 200 & pred_10000_mean_roll_1000 < 1000)|

   (pred_10000_mean_roll_10 > pred_10000_mean_roll_1000 + 2.5*pred_10000_sd_roll_1000  &
   pred_10000_mean_roll_10 < pred_10000_mean_roll_1000 + 10*pred_10000_sd_roll_1000)|
   (pred_10000_mean_roll_2000 > 15 & pred_10000_mean_roll_2000 < 20)|
   (pred_10000_mean_roll_50 > pred_10000_mean_roll_2000 + 2.3*pred_10000_sd_roll_2000 &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_2000 + 10*pred_10000_sd_roll_2000)|
   (predicted > pred_10000_mean_roll_500 + 3.15*pred_10000_sd_roll_500  &
   predicted < pred_10000_mean_roll_500 + 10*pred_10000_sd_roll_500)|
   (pred_10000_mean_roll_50 > pred_10000_mean_roll_500 + 2.4*pred_10000_sd_roll_500  &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_500 + 10*pred_10000_sd_roll_500)|
   (pred_10000_mean_roll_50 > pred_10000_mean_roll_600 + 2.45*pred_10000_sd_roll_600  &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_600 + 10*pred_10000_sd_roll_600)|

   (pred_10000_mean_roll_10 > pred_10000_mean_roll_250 + 0.725*pred_10000_sd_roll_250  &
   pred_10000_mean_roll_10 < pred_10000_mean_roll_250 + 0.9*pred_10000_sd_roll_250)|
   (pred_10000_mean_roll_50 > pred_10000_mean_roll_250 + 0.175*pred_10000_sd_roll_250  &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_250 + 0.25*pred_10000_sd_roll_250)
"

trade_statment <-
  "(predicted > 80 & predicted < 1000)|
   (pred_10000_mean_roll_250 > 50 & pred_10000_mean_roll_250 < 1000)|
   (pred_10000_mean_roll_500 > 45 & pred_10000_mean_roll_500 < 1000)|
   (pred_10000_mean_roll_1000 > 35 & pred_10000_mean_roll_1000 < 1000)|
   (pred_10000_mean_roll_2000 > 32 & pred_10000_mean_roll_2000 < 1000)|

   (pred_10000_mean_roll_50 > pred_10000_mean_roll_250 + 1.75*pred_10000_sd_roll_250  &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_250 + 10*pred_10000_sd_roll_250)|

   (predicted > pred_10000_mean_roll_500 + 1.725*pred_10000_sd_roll_500  &
   predicted < pred_10000_mean_roll_500 + 2.5*pred_10000_sd_roll_500)|

   (pred_10000_mean_roll_50 > pred_10000_mean_roll_2000 + 1.25*pred_10000_sd_roll_2000  &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_2000 + 10*pred_10000_sd_roll_2000)|
   (pred_10000_mean_roll_50 > pred_10000_mean_roll_1000 + 1.25*pred_10000_sd_roll_1000  &
   pred_10000_mean_roll_50 < pred_10000_mean_roll_1000 + 10*pred_10000_sd_roll_1000)|

   (pred_10000_mean_roll_100 > pred_10000_mean_roll_2000 + 0.9*pred_10000_sd_roll_2000  &
   pred_10000_mean_roll_100 < pred_10000_mean_roll_2000 + 1.5*pred_10000_sd_roll_2000)|
