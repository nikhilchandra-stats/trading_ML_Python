...
trade_statment <-
  ...
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.4*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'CH20_CHF')|
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.4*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'DE30_EUR')|
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.55*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'EU50_EUR')|
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.55*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  ...
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'JP225Y_JPY')|
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.6*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'SPX500_USD')|
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.5*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'UK100_GBP')|
  # (predicted_portfolio >= pred_portfolio_10000_mean_roll_2000 + 0.9*pred_portfolio_10000_sd_roll_2000 &
  # predicted_portfolio <= pred_portfolio_10000_mean_roll_2000 + 50*pred_portfolio_10000_sd_roll_2000 &
  # Asset == 'US2000_USD')
...
return_thresh <- 5
auc_roc_list <- list()
col_to_test <- "pnorm_1001"
col_to_test_port <- "pnorm_1001"
c = 0
