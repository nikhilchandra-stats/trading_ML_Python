...
file_name = "MIXED_PORT_risk5_stop4_prof8_SIG10-7"
...
trade_statment <-
  "
   (predicted > 5 & predicted < 1000)|

   (predicted > pred_10000_mean_roll_250 + 2*pred_10000_mean_roll_250 &
    predicted < pred_10000_mean_roll_250 + 10*pred_10000_mean_roll_250)|

    (predicted > pred_10000_mean_roll_500 + 1*pred_10000_sd_roll_500 &
    predicted < pred_10000_mean_roll_500 + 10*pred_10000_sd_roll_500)|

    (predicted > pred_10000_mean_roll_100 + 0.5*pred_10000_mean_roll_100 &
    predicted < pred_10000_mean_roll_100 + 2*pred_10000_mean_roll_100)|

    (predicted > pred_10000_mean_roll_100 + 1.25*pred_10000_sd_roll_100 &
    predicted < pred_10000_mean_roll_100 + 1.9*pred_10000_sd_roll_100)|

    (pred_10000_mean_roll_2000 > 2 & pred_10000_mean_roll_2000 < 1000)|

    (pred_10000_mean_roll_100 > 9.3 & pred_10000_mean_roll_100 < 1000)|

    (pred_10000_mean_roll_50 > 8.75 & pred_10000_mean_roll_50 < 1000)|

    (pred_10000_mean_roll_50 > pred_10000_mean_roll_500 + 0.65*pred_10000_mean_roll_500 &
    pred_10000_mean_roll_50 < pred_10000_mean_roll_500 + 1*pred_10000_mean_roll_500)|

    (pred_10000_mean_roll_50 > pred_10000_mean_roll_1000 + 1.725*pred_10000_sd_roll_1000 &
    pred_10000_mean_roll_50 < pred_10000_mean_roll_1000 + 2*pred_10000_sd_roll_1000)|

    (pred_10000_mean_roll_50 > pred_10000_mean_roll_500 + 1.25*pred_10000_sd_roll_500 &
    pred_10000_mean_roll_50 < pred_10000_mean_roll_500 + 1.5*pred_10000_sd_roll_500)|

    (pred_10000_mean_roll_50 > pred_10000_mean_roll_1500 + 1.2*pred_10000_sd_roll_1500 &
    pred_10000_mean_roll_50 < pred_10000_mean_roll_1500 + 1.35*pred_10000_sd_roll_1500)|

    (pred_10000_mean_roll_10 > 12 & pred_10000_mean_roll_10 < 1000)|

    (pred_10000_mean_roll_10 > pred_10000_mean_roll_1000 + 0.75*pred_10000_sd_roll_1000 &
    pred_10000_mean_roll_10 < pred_10000_mean_roll_1000 + 1.5*pred_10000_sd_roll_1000)|

    (pred_10000_mean_roll_10 > pred_10000_mean_roll_100 + 1.3*pred_10000_sd_roll_100 &
    pred_10000_mean_roll_10 < pred_10000_mean_roll_100 + 1.75*pred_10000_sd_roll_100)|

    (pred_10000_mean_roll_10 > pred_10000_mean_roll_250 + 0.85*pred_10000_sd_roll_250 &
    pred_10000_mean_roll_10 < pred_10000_mean_roll_250 + 1.1*pred_10000_sd_roll_250)|

    (pred_10000_mean_roll_10 > pred_10000_mean_roll_500 + 0.25*pred_10000_mean_roll_500 &
    pred_10000_mean_roll_10 < pred_10000_mean_roll_500 + 1*pred_10000_mean_roll_500)|

    (pred_10000_mean_roll_10 > pred_10000_mean_roll_50 + 1.4*pred_10000_sd_roll_50 &
    pred_10000_mean_roll_10 < pred_10000_mean_roll_50 + 1.5*pred_10000_sd_roll_50)|
