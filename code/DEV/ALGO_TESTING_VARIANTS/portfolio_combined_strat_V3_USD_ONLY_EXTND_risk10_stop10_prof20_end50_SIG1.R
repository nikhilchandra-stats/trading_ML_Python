...
all_preds <-
  Portfolio_get_all_preds_frm_V3(
    ...
    date_for_true_simualtion = start_date,
...
file_name = "USD_ONLY_EXTND_risk10_stop10_prof20_end50_SIG1"
...
trade_statment <-
  "(pred_10000_mean_roll_1000 > 55 & pred_10000_mean_roll_1000 < 1000)|
  (pred_10000_mean_roll_500 > 190 & pred_10000_mean_roll_500 < 1000)|
  (pred_10000_mean_roll_250 > 190 & pred_10000_mean_roll_250 < 1000)|
  (predicted > 10 & predicted < 38)|
  (pred_10000_mean_roll_1500 > 45 & pred_10000_mean_roll_1500 < 1000)|
  (pred_10000_mean_roll_600 > 68 & pred_10000_mean_roll_600 < 1000)|
  (predicted > pred_10000_mean_roll_1000 + 0*pred_10000_sd_roll_1000 &
    predicted < pred_10000_mean_roll_1000 + 0.2*pred_10000_sd_roll_1000)"

trade_statment <-
  " (predicted > pred_10000_mean_roll_1500 + 1.25*pred_10000_sd_roll_1500 &
...
dim(analyse_performance %>% filter(trade_col == "Long"))
dim(control)
