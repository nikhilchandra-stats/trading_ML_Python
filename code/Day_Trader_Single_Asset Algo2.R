...
source("code/trade_statement/trade_statement_v2.R")

assets_to_use <- assets_to_use[14:23]
...
while (current_time < end_time) {
  ...
  if(trades_closed == 0 &
     now(tzone = "Australia/Canberra") > as_datetime("2026-07-20 07:00:00", tz = "Australia/Canberra")  ) {
